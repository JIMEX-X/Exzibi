...
export default function Certification({ url }: Props) {
  ...
  return (
    ...
    >
      <section className="md:bg-gray-100 max-w-[42rem] border  flex items-center border-black/5 rounded-lg overflow-hidden sm:pr-8 pl-3 relative  h-fit py-3 md:hover:bg-gray-200 transition  dark:text-white dark:bg-white/10 dark:md:hover:bg-white/20">
        {metadata && (
